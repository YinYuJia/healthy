<template>
  <div class="chronicDisease">
    ...
    <!-- 规定病种 -->
    <SearchInfoPage ref="species" type="AKA035" :jy7211Medical='true'  @childrenClick="speciesClick"></SearchInfoPage>
    <!-- 疾病1 -->
    <SearchInfoPage ref="disease1" type="AKA120" :jy7211Medical='true' @childrenClick="disease1Click"></SearchInfoPage>
    <!-- <SearchInfoPage ref="disease1" type="AKA130" AAE013="AKA035" :AAA052="form.AKA035" @childrenClick="disease1Click"></SearchInfoPage> -->
    <!-- 疾病2 -->
    <SearchInfoPage ref="disease2" type="AKA120" :jy7211Medical='true' @childrenClick="disease2Click"></SearchInfoPage>
    ...
    <SearchInfoPage ref="disease3" type="AKA120" :jy7211Medical='true' @childrenClick="disease3Click"></SearchInfoPage>
  </div>
</template>
